function t(t,e,a,i){Object.defineProperty(t,e,{get:a,set:i,enumerable:!0,configurable:!0})}var e=globalThis,a={},i={},o=e.parcelRequirefc44;null==o&&((o=function(t){if(t in a)return a[t].exports;if(t in i){var e=i[t];delete i[t];var o={id:t,exports:{}};return a[t]=o,e.call(o.exports,o,o.exports),o.exports}var n=Error("Cannot find module '"+t+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(t,e){i[t]=e},e.parcelRequirefc44=o);var n=o.register;n("evz6q",function(e,a){async function i(){try{let t=await fetch("/api/v1/events");if(!t.ok)throw Error(`HTTP error! Status: ${t.status}`);return await t.json()}catch(t){console.error("Failed to fetch data:",t)}}async function o(){let t=await i(),e=new Date;return t.sort((t,a)=>{let i=new Date(t.start_date),o=new Date(a.start_date);return n(e,i)-n(e,o)})}t(e.exports,"sortDataByDate",()=>o);let n=(t,e)=>(e-t)/864e5}),n("eVKce",function(e,a){function i(t){let e=new Date(t),a=e.getDate(),i=["January","February","March","April","May","June","July","August","September","October","November","December"][e.getMonth()],o=e.getFullYear(),n=function(t){if(t>3&&t<21)return"th";switch(t%10){case 1:return"st";case 2:return"nd";case 3:return"rd";default:return"th"}}(a);return`${i} ${a}${n}, ${o}`}t(e.exports,"formatDate",()=>i)});var l=o("800sp"),s=o("evz6q"),r=o("eVKce");class d extends l.LitElement{constructor(){super(),this.eventData=[],this.userIsAuthorized=!1}static get properties(){return{eventData:{type:Array,attribute:!1},userIsAuthorized:{type:Boolean,attribute:!1}}}static get styles(){return(0,l.css)`
    ...
    `}async connectedCallback(){super.connectedCallback(),this.eventData=await (0,s.sortDataByDate)();let t=sessionStorage.getItem("authorized-user");null===t||"false"==t?this.userIsAuthorized=!1:this.userIsAuthorized=!0,document.addEventListener("auth-state",t=>{console.log("here was supposed to dispatch"),this.userIsAuthorized=t.detail})}render(){return(0,l.html)`
    <link rel="stylesheet" href="/index.css">
      ${this.userIsAuthorized?(0,l.html)`
        ...
        <div class="event">
          ...
          <div class="event-data">
            ...
            <div class="event-info">
              <p>${(0,r.formatDate)(t.start_date)} - ${(0,r.formatDate)(t.end_date)}</p>
          ...
          ${this.userIsAuthorized?(0,l.html)`
            ...
            `:(0,l.html)``}
        </div>`):(0,l.html)`<p>No upcoming events</p>`}
    `}openNewEventForm(){this.shadowRoot.querySelector("#dialog__event--new").showModal()}closeNewEventForm(){this.shadowRoot.querySelector("#dialog__event--new").close()}cancelDeleteEventDialog(){this.shadowRoot.querySelector("#dialog__event--delete").close()}async openDeleteEventDialog(t){this.shadowRoot.querySelector("#dialog__event--delete").showModal(),this.shadowRoot.querySelector("#dialogTitle").textContent=`Are you sure you want to delete the event '${t}'?`}async confirmDeleteEvent(t){let e=parseInt(t.target.getAttribute("data-id"));try{if((await fetch(`/api/v1/events/${e}`,{method:"DELETE"})).ok)this.eventData=await (0,s.sortDataByDate)();else throw Error("Failed to delete event")}catch(t){console.error("Error:",t),alert("An error occurred while trying to delete the event.")}this.shadowRoot.querySelector("#dialog__event--delete").close()}closeEditEventForm(){this.shadowRoot.querySelector("#dialog__event--edit").close(),this.shadowRoot.querySelector("#form__event--edit").reset()}async editEvent(t){let e=parseInt(t.target.getAttribute("data-id"));this.shadowRoot.querySelector("#dialog__event--edit").showModal();try{let t=await fetch(`/api/v1/events/${e}`),a=(await t.json())[0];console.log(a),this.shadowRoot.querySelector("#edit__title").value=a.title,this.shadowRoot.querySelector("#edit__start_date").value=this.formatDate(a.start_date),this.shadowRoot.querySelector("#edit__end_date").value=this.formatDate(a.end_date),this.shadowRoot.querySelector("#edit__location").value=a.location,this.shadowRoot.querySelector("#edit__details").value=a.details,this.shadowRoot.querySelector(".edit__id--hidden").value=a.id}catch(t){console.error("Error: ",t)}}async updateEvent(t){t.preventDefault();let e=this.shadowRoot.querySelector("#dialog__event--edit"),a=this.shadowRoot.querySelector(".edit__id--hidden").value,i=this.shadowRoot.querySelector("#form__event--edit"),o={title:this.shadowRoot.querySelector("#edit__title").value,start_date:this.shadowRoot.querySelector("#edit__start_date").value,end_date:this.shadowRoot.querySelector("#edit__end_date").value,location:this.shadowRoot.querySelector("#edit__location").value,details:this.shadowRoot.querySelector("#edit__details").value,id:this.shadowRoot.querySelector(".edit__id--hidden").value};try{(await fetch(`/api/v1/events/${a}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(o)})).ok?(console.info("Successfully updated event"),i.reset(),e.close()):console.error("Failed to update event")}catch(t){console.error(t)}this.eventData=await (0,s.sortDataByDate)()}formatDate(t){return new Date(t).toISOString().split("T")[0]}}customElements.define("event-component",d);
//# sourceMappingURL=news.44d38124.js.map
